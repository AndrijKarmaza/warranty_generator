...
export const pdfCreatorDad = data => {
  ...
  pdf.setFontSize(11).text('ФОП Александрочкін Олександр Юрійович', 10, 18);
  pdf.text('Код за ДРФО 2450110376', 10, 23);
  pdf.text('Україна, 65012, м.Одеса, вул. Ясна, 4 кв. 9-А', 30, 28);
